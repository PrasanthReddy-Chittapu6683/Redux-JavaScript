...
/** It is responsible to Holds application state
    createStore method accepts the 'reducer()' function as a 1st paramert
    applyMyMiddleware is the middleware fucntion that accpets logger. Here we can add multiple loggers aswell.
*/
